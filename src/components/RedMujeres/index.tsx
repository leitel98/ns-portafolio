...
import Pinkline from '../RedMujeres/pinkline'

export const WomanWeb = () => {
  const images = [
    "/car-1.png",
    "/car-2.png",
    "/car-3.png",
  ...
  return (
    <>
      ...
      <section id="flow" className="pt-20 pb-10 px-6 bg-mintole flex flex-col space-y-16 md:space-y-24 items-center bg-opacity-60">
        {/* header */}
        <div className="flex flex-col space-y-8 md:flex-row md:space-y-0 md:space-x-48 items-center md:items-start">
          <h1 className="font-rosario font-bold text-md md:text-lg max-w-sm text-center">
            Task Flow and User Flow
          </h1>
          <p className="max-w-xl text-sm">
            In order to understand how the users would use the app, I made a <span className="font-bold"> task flow</span> and <span className="font-bold">user flow</span> to find all the possible interactions that would be necessary to achieve the main functions defined by the <span className="font-bold">MVP</span>.
          </p>
        </div>
        {/* task flow */}
        <div className="flex flex-col justify-center w-full md:px-12 mb-32">
          <h1 className="text-sm text-center md:text-md font-bold mb-12">
            Task Flow
          </h1>
          <Pinkline />
          <div className="grid grid-cols-3 grid-rows-2 gap-4 md:flex md:flex-row justify-between items-center text-center">
            <div className="p bg-white px-4 py-8 font-bold text-xxs md:text-xs rounded-lg">
              Register or Sign In
            </div>
            <div className="p bg-white px-4 py-4 font-bold text-xxs md:text-xs rounded-lg max-w-[15rem]">
              Verify that you are a woman
            </div>
            <div className="p bg-white px-10 py-8 font-bold text-xxs md:text-xs rounded-lg">
              Make a post
            </div>
            <div className="p bg-white px-4 py-8 font-bold text-xxs md:text-xs rounded-lg">
        ...
        {/* user flow */}
        <div className="flex flex-col space-y-8 md:flex-row md:space-y-0 md:space-x-24 items-center md:items-start">
          <h1 className="text-sm md:text-md font-bold">
            User Flow
          </h1>
          <p className="text-xxs md:text-xs text-justify max-w-2xl">
            A new user would follow a path like this in most occasions, as scrolling, searching and discovering the app usually is the first thing one does. Once someone is more familiar and confident with it they would go on to publish something or chatting, which are the paths in grey.
          </p>
        </div>
        <Image
        ...
        />
        {/* site map */}
        <div className="flex flex-col space-y-8 md:flex-row md:space-y-0 md:space-x-96 items-center md:items-start">
          <h1 className="text-sm md:text-md font-bold">
            Site Map
          </h1>
          <p className="text-xxs md:text-xs text-justify max-w-md">
            The site map was created by establishing a hypothesis of what it would look like. Then using the results of a <span className="font-bold">card sorting</span> exercise by users, the final map was defined.
          </p>
        </div>
        <h1 className="text-sm md:text-md font-bold">
